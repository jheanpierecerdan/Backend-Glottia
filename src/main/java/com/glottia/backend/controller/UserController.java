...
@Tag(name = "Usuarios", description = "GestiÃƒÆ’Ã‚Â³n de usuarios de Glottia")
public class UserController {
    ...
    public UserDTO createUser(@RequestBody UserDTO userDto) {
        ...
        boolean publicRegistration = authentication == null || !authentication.isAuthenticated()
                || authentication instanceof AnonymousAuthenticationToken;
        if (publicRegistration || userDto.getIdRol() == null) {
            userDto.setIdRol(roleRepository.findByNombre("ESTUDIANTE")
                    .orElseThrow(() -> new IllegalStateException("Rol ESTUDIANTE no configurado"))
                    .getIdRol());
        }
