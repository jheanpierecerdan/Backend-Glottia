...
public class EventController {
    ...
    private EventDTO convertToDto(Event event) {
        ...
        dto.setImagenReferencial(event.getImagenReferencial());
        dto.setNivelSugerido(event.getNivelSugerido());
    ...
    private Event convertToEntity(EventDTO dto) {
        ...
        event.setImagenReferencial(dto.getImagenReferencial());
        event.setNivelSugerido(dto.getNivelSugerido());
