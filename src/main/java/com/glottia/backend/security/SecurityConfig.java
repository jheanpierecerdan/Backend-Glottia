    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/", "/error", "/api/health", "/api/wakeup", "/ingresos", "/swagger-ui.html", "/swagger-ui/**", "/v3/api-docs", "/v3/api-docs/**", "/api-docs", "/api-docs/**", "/swagger-resources/**", "/webjars/**").permitAll()
                        ...
                        // ORGANIZADOR: gestiÃ³n de eventos
                        // DOCENTE: gestiÃ³n de reuniones (que ahora son un tipo especial de Event)
                        // Se asume que en el controlador de eventos se harÃ¡ la distinciÃ³n, o aquÃ­ podemos permitir que ambos gestionen eventos.
